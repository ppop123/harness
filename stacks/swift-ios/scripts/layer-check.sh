#!/usr/bin/env bash
# layer-check.sh — Structural dependency test for Swift + SwiftUI
#
# Enforces: Models → Repositories → Services → ViewModels → Views
...
LANG = 'Swift'
EXT = 'swift'
RULES = json.loads('[{"layer": "Models", "source_aliases": ["Models"], "forbidden": ["Repositories", "Services", "ViewModels", "Views"]}, {"layer": "Repositories", "source_aliases": ["Repositories"], "forbidden": ["Services", "ViewModels", "Views"]}, {"layer": "Services", "source_aliases": ["Services"], "forbidden": ["ViewModels", "Views"]}, {"layer": "ViewModels", "source_aliases": ["ViewModels"], "forbidden": ["Views"]}]')
