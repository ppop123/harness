#!/usr/bin/env bash
# layer-check.sh — Structural dependency test for Python + Django
#
# Enforces: Models → Managers → Services → Serializers → Views → URLs
...
LANG = 'Python'
EXT = 'py'
RULES = json.loads('[{"layer": "Models", "source_aliases": ["models"], "forbidden": ["managers", "services", "serializers", "views", "urls"]}, {"layer": "Managers", "source_aliases": ["managers"], "forbidden": ["services", "serializers", "views", "urls"]}, {"layer": "Services", "source_aliases": ["services"], "forbidden": ["serializers", "views", "urls"]}, {"layer": "Serializers", "source_aliases": ["serializers"], "forbidden": ["views", "urls"]}, {"layer": "Views", "source_aliases": ["views"], "forbidden": ["urls"]}]')
