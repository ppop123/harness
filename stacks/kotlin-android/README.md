# Kotlin + Android — Harness Engineering 模板

**分类**：Android 客户端
**语言**：Kotlin
**框架**：Jetpack Compose + Hilt + Coroutines
...
```text
从 https://github.com/ppop123/harness 装载 kotlin-android 栈的 harness 工程结构到当前目录
```
...
|------|------|
| ktlint + detekt | 代码检查 |
| Kotlin 编译器（静态类型） | 类型检查 |
| JUnit 5 + Turbine | 测试 |
| ktlint format | 格式化 |
| Kotlin data class + sealed class | 数据验证 |
