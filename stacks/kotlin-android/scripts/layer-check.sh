#!/usr/bin/env bash
# layer-check.sh — Structural dependency test for Kotlin + Android
#
# Enforces: Data (Models) → Repository → UseCase → ViewModel → UI
...
LANG = 'Kotlin'
EXT = 'kt'
RULES = json.loads('[{"layer": "Data (Models)", "source_aliases": ["data/model", "domain/model"], "forbidden": ["data/repository", "domain/repository", "domain/usecase", "presentation/viewmodel", "presentation/ui", "ui"]}, {"layer": "Repository", "source_aliases": ["data/repository", "domain/repository"], "forbidden": ["domain/usecase", "presentation/viewmodel", "presentation/ui", "ui"]}, {"layer": "UseCase", "source_aliases": ["domain/usecase"], "forbidden": ["presentation/viewmodel", "presentation/ui", "ui"]}, {"layer": "ViewModel", "source_aliases": ["presentation/viewmodel"], "forbidden": ["presentation/ui", "ui"]}]')
