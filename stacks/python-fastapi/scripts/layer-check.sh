#!/usr/bin/env bash
# layer-check.sh — Structural dependency test for Python + FastAPI
#
# Enforces: Models → Config → Utils → Repositories → Services → Routes
...
LANG = 'Python'
EXT = 'py'
RULES = json.loads('[{"layer": "Models", "source_aliases": ["models"], "forbidden": ["config", "utils", "common", "repositories", "services", "routes"]}, {"layer": "Config", "source_aliases": ["config"], "forbidden": ["utils", "common", "repositories", "services", "routes"]}, {"layer": "Utils", "source_aliases": ["utils", "common"], "forbidden": ["repositories", "services", "routes"]}, {"layer": "Repositories", "source_aliases": ["repositories"], "forbidden": ["services", "routes"]}, {"layer": "Services", "source_aliases": ["services"], "forbidden": ["routes"]}]')
