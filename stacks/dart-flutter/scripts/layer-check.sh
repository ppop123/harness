#!/usr/bin/env bash
# layer-check.sh — Structural dependency test for Dart + Flutter
#
# Enforces: Models → Data Sources → Repositories → Providers/Blocs → UI
...
LANG = 'Dart'
EXT = 'dart'
RULES = json.loads('[{"layer": "Models", "source_aliases": ["models"], "forbidden": ["data/remote", "data/local", "repositories", "providers", "blocs", "ui"]}, {"layer": "Data Sources", "source_aliases": ["data/remote", "data/local"], "forbidden": ["repositories", "providers", "blocs", "ui"]}, {"layer": "Repositories", "source_aliases": ["repositories"], "forbidden": ["providers", "blocs", "ui"]}, {"layer": "Providers/Blocs", "source_aliases": ["providers", "blocs"], "forbidden": ["ui"]}]')
