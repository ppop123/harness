#!/usr/bin/env bash
# layer-check.sh — Structural dependency test for Rust
#
# Enforces: Models → Config → Repository → Service → Handler → Router
...
LANG = 'Rust'
EXT = 'rs'
RULES = json.loads('[{"layer": "Models", "source_aliases": ["models"], "forbidden": ["config", "repository", "service", "handler", "router"]}, {"layer": "Config", "source_aliases": ["config"], "forbidden": ["repository", "service", "handler", "router"]}, {"layer": "Repository", "source_aliases": ["repository"], "forbidden": ["service", "handler", "router"]}, {"layer": "Service", "source_aliases": ["service"], "forbidden": ["handler", "router"]}, {"layer": "Handler", "source_aliases": ["handler"], "forbidden": ["router"]}]')
