#!/usr/bin/env bash
# layer-check.sh — Structural dependency test for React Native (TypeScript)
#
# Enforces: Types → Config → Services/API → Hooks → Screens → Components
...
LANG = 'TypeScript'
EXT = 'ts'
RULES = json.loads('[{"layer": "Types", "source_aliases": ["types"], "forbidden": ["config", "services", "api", "hooks", "screens", "components"]}, {"layer": "Config", "source_aliases": ["config"], "forbidden": ["services", "api", "hooks", "screens", "components"]}, {"layer": "Services/API", "source_aliases": ["services", "api"], "forbidden": ["hooks", "screens", "components"]}, {"layer": "Hooks", "source_aliases": ["hooks"], "forbidden": ["screens", "components"]}, {"layer": "Screens", "source_aliases": ["screens"], "forbidden": ["components"]}]')
