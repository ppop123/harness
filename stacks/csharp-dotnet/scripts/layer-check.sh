#!/usr/bin/env bash
# layer-check.sh — Structural dependency test for C# + ASP.NET Core
#
# Enforces: DTOs → Config → Repositories → Services → Controllers
...
LANG = 'C#'
EXT = 'cs'
RULES = json.loads('[{"layer": "DTOs", "source_aliases": ["DTOs"], "forbidden": ["Config", "Repositories", "repository", "Services", "service", "Controllers", "controller"]}, {"layer": "Config", "source_aliases": ["Config"], "forbidden": ["Repositories", "repository", "Services", "service", "Controllers", "controller"]}, {"layer": "Repositories", "source_aliases": ["Repositories", "repository"], "forbidden": ["Services", "service", "Controllers", "controller"]}, {"layer": "Services", "source_aliases": ["Services", "service"], "forbidden": ["Controllers", "controller"]}]')
