#!/usr/bin/env bash
# layer-check.sh — Structural dependency test for TypeScript + Next.js
#
# Enforces: Types → Config → Utils → Repositories → Services → API Routes → UI/Pages
...
LANG = 'TypeScript'
EXT = 'ts'
RULES = json.loads('[{"layer": "Types", "source_aliases": ["types"], "forbidden": ["config", "lib", "utils", "repositories", "services", "app/api", "api", "routes", "app", "components", "pages", "ui"]}, {"layer": "Config", "source_aliases": ["config"], "forbidden": ["lib", "utils", "repositories", "services", "app/api", "api", "routes", "app", "components", "pages", "ui"]}, {"layer": "Utils", "source_aliases": ["lib", "utils"], "forbidden": ["repositories", "services", "app/api", "api", "routes", "app", "components", "pages", "ui"]}, {"layer": "Repositories", "source_aliases": ["repositories"], "forbidden": ["services", "app/api", "api", "routes", "app", "components", "pages", "ui"]}, {"layer": "Services", "source_aliases": ["services"], "forbidden": ["app/api", "api", "routes", "app", "components", "pages", "ui"]}, {"layer": "API Routes", "source_aliases": ["app/api", "api", "routes"], "forbidden": ["app", "components", "pages", "ui"]}]')
