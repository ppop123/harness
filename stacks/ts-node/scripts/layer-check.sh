#!/usr/bin/env bash
# layer-check.sh — Structural dependency test for TypeScript + Node.js API
#
# Enforces: Types → Config → Utils → Repositories → Services → Controllers → Routes
...
LANG = 'TypeScript'
EXT = 'ts'
RULES = json.loads('[{"layer": "Types", "source_aliases": ["types"], "forbidden": ["config", "utils", "lib", "repositories", "services", "controllers", "routes"]}, {"layer": "Config", "source_aliases": ["config"], "forbidden": ["utils", "lib", "repositories", "services", "controllers", "routes"]}, {"layer": "Utils", "source_aliases": ["utils", "lib"], "forbidden": ["repositories", "services", "controllers", "routes"]}, {"layer": "Repositories", "source_aliases": ["repositories"], "forbidden": ["services", "controllers", "routes"]}, {"layer": "Services", "source_aliases": ["services"], "forbidden": ["controllers", "routes"]}, {"layer": "Controllers", "source_aliases": ["controllers"], "forbidden": ["routes"]}]')
