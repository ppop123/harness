#!/usr/bin/env bash
# layer-check.sh — Structural dependency test for Python AI / Data Science
#
# Enforces: Config → Data → Models → Pipelines → Evaluation → API/UI
...
LANG = 'Python'
EXT = 'py'
RULES = json.loads('[{"layer": "Config", "source_aliases": ["config"], "forbidden": ["data", "models", "pipelines", "evaluation", "api", "ui"]}, {"layer": "Data", "source_aliases": ["data"], "forbidden": ["models", "pipelines", "evaluation", "api", "ui"]}, {"layer": "Models", "source_aliases": ["models"], "forbidden": ["pipelines", "evaluation", "api", "ui"]}, {"layer": "Pipelines", "source_aliases": ["pipelines"], "forbidden": ["evaluation", "api", "ui"]}, {"layer": "Evaluation", "source_aliases": ["evaluation"], "forbidden": ["api", "ui"]}]')
