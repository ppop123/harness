# Java + Spring Boot — Harness Engineering 模版
...
```text
从 https://github.com/ppop123/harness 装载 java-spring 栈的 harness 工程结构到当前目录
```
...
| 工具 | 用途 |
|------|------|
| Checkstyle + SpotBugs | 代码检查 |
| Java 编译器（静态类型） | 类型检查 |
| JUnit 5 + Mockito | 测试 |
| google-java-format | 格式化 |
| Jakarta Validation (Bean Validation) | 数据验证 |
